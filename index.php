...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Lyman Wong | Web Developer</title>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 text-center">
                    <div class="feature">
                        <!-- <i class="icon-lg ion-android-person wow fadeInUp" data-wow-delay=".2s"></i> -->
                        <a href="#galleryModal" class="gallery-box-alt" data-toggle="modal" data-src="http://lymanwong.com/images/josh.jpg"><img class="profile" src="images/josh.jpg" alt="This is a picture of my friend, Josh, a co-worker at Zynga."></a>
                        <h3>Josh W.</h3>
                ...
                <div class="col-lg-4 col-md-4 text-center">
                    <div class="feature">
                        <!-- <i class="icon-lg ion-android-person wow fadeIn" data-wow-delay=".3s"></i> -->
                        <a href="#galleryModal" class="gallery-box-alt" data-toggle="modal" data-src="http://lymanwong.com/images/eric.jpg"><img class="profile"src="images/eric.jpg" alt="This is a picture of my friend, Eric, from Zynga."></a>
                        <h3>Eric A.</h3>
